...
export default function Navbar() {
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-3 z-30 px-3 sm:bottom-4">
      <Dock className="z-50 pointer-events-auto relative h-12 max-w-full p-1.5 w-fit mx-auto flex gap-1 overflow-x-auto overflow-y-hidden border bg-card/90 backdrop-blur-3xl shadow-[0_0_10px_3px] shadow-primary/5 sm:h-14 sm:p-2 sm:gap-2 sm:overflow-visible">
